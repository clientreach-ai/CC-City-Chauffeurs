...
import { SectionLabel, shell } from "@/components/site/primitives";
import { VehicleEntry, type VehicleEntryData } from "@/components/site/vehicle-entry";
import { passengersText, rateLabel, UNCONFIRMED } from "@/lib/cms/format";
import { availabilityOptions, labelFor } from "@/lib/cms/status";
import type { FleetCategory, PublishStatus, VehicleInput } from "@/lib/cms/types";
...
export function toEntryData(vehicle: VehicleInput): VehicleEntryData {
  ...
  return {
    ...
    image: main ? { src: main.src, width: main.width, height: main.height } : undefined,
    imageAlt: main?.alt,
    specs: [
