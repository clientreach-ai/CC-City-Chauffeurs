...
import { formatRelative, rateLabel, slugify } from "@/lib/cms/format";
...
import { availabilityOptions, ownershipOptions } from "@/lib/cms/status";
import type { PublishStatus, Vehicle, VehicleInput } from "@/lib/cms/types";
