...
import { IndexRows } from "@CC-City-Chauffeurs/ui/site/index-rows";
...
import type { PublishStatus, ServiceInput, Vehicle } from "@CC-City-Chauffeurs/core";
...
export function ServicePreview({
  ...
  // Stored site-relative; the website serves it, this origin does not.
  const hero = service.heroImage
    ? { ...service.heroImage, src: resolveImageSrc(service.heroImage.src, SITE_URL) }
    : null;
